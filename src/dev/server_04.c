...
#define COLON ':'
#define DEBUG 0
#define HTML_PATH "/home/hector/SideProject/MakeHttpserver/"
...
inline int file_exists(char *filename) { return (access(filename, 0) == 0); }
...
void wrong_file(int sockfd, char *filename)
{
	char buf[BUFF_SIZE];
	char *err_404 = NULL;
